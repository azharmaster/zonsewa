    ...
    <main class="max-w-[640px] mx-auto min-h-screen flex flex-col relative has-[#Bottom-nav]:pb-[144px]">
        ...
        <section id="brand"
            ...
            <div class="flex flex-col items-end gap-[2x]">
                ...
                <p class="text-sm leading-[21px] text-[#6E6E70] text-nowrap">{{ $brand->products->count() }}
                    Products</p>
            </div>
        </section>
        <section id="Explore" class="flex flex-col gap-[10px] mx-5 mt-[30px]">
            ...
            <div class="flex flex-col gap-5">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="w-full flex flex-col gap-1">
                            ...
                            <div class="flex items-center justify-between">
                                <p class="text-sm leading-[21px] text-[#6E6E70]">RM {{ number_format($product->price, 0, ',', '.') }}/Day</p>
                                <div class="flex items-center w-fit gap-[2px]">
                                    ...
                                    <p class="text-sm leading-[21px]"><span class="font-semibold">4/5</span> <span
                                            class="text-[#6E6E70]">({{$product->category->name}})</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @empty
                <p>Belum ada produk dari brand {{$brand->name}}</p>
                @endforelse
