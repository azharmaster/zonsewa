            ...
            <div id="Customer-info" class="flex flex-col px-5 gap-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="group w-full rounded-2xl border border-[#EDEEF0] p-[18px_14px] flex items-center gap-3 relative transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FCCF2F]">
                        ...
                        <input type="hidden" name="store" value="{{$product->store_id}}" />
            ...
            <div id="Payment-details" class="flex flex-col px-5 gap-3">
                ...
                <div class="flex flex-col gap-4">
                    <div class="flex items-center justify-between">
                        <p>Sub total</p>
                        <p class="font-semibold">RM {{ number_format($subTotal, 0, ',', '.') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <p>PPN 11%</p>
                        <p class="font-semibold">RM {{ number_format($totalPpn, 0, ',', '.') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <p>Insurance</p>
                        <p class="font-semibold">RM {{ number_format($insurance, 0, ',', '.') }}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <p>Grand total</p>
                        <p class="font-bold text-xl leading-[30px] underline">RM {{ number_format($grandTotal, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
            <hr class="border-[#EDEEF0] mx-5">
