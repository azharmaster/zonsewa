...
@endif
    ...
    <div class="flex items-center justify-between px-5">
        ...
        <div class="flex items-center gap-3 relative">
            <button type="button" id="Minus" class="w-11 h-11 flex shrink-0 rounded-full transition-all duration-300 hover:ring-2 hover:ring-[#FCCF2F]">
            ...
            <button type="button" id="Plus" class="w-11 h-11 flex shrink-0 rounded-full transition-all duration-300 hover:ring-2 hover:ring-[#FCCF2F]">
    ...
    <div class="flex flex-col px-5 gap-2">
        ...
        <div class="group w-full rounded-2xl border border-[#EDEEF0] p-[18px_14px] flex items-center gap-3 relative transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FCCF2F]">
            ...
            <button type="button" id="DateTriggerBtn" class="w-full appearance-none text-left" onclick="document.getElementById('date').showPicker()">Select date</button>
    ...
    <div class="flex flex-col px-5 gap-2">
        ...
        <div id="Menus" class="flex flex-col gap-4">
            <div class="tab-link-btns flex items-center gap-4">
                <label class="tablink relative w-full rounded-2xl p-[18px_14px] border border-[#EDEEF0] font-semibold text-sm leading-[21px] transition-all duration-300 hover:ring-2 hover:ring-[#FCCF2F]" onclick="openPage('pickup-tab', this)" id="defaultOpen">
                    ...
                    <input type="radio" name="delivery_type" value="pickup" class="absolute -z-10 top-1/2 left-1/2 opacity-0" onchange="toggleRequiredOptions()" required />
                </label>
                <label class="tablink relative w-full rounded-2xl p-[18px_14px] border border-[#EDEEF0] font-semibold text-sm leading-[21px] transition-all duration-300 hover:ring-2 hover:ring-[#FCCF2F]" onclick="openPage('delivery-tab', this)">
                    <div class="flex items-center gap-3">
                        <div class="w-6 h-6 flex shrink-0">
                    ...
                    <input type="radio" name="delivery_type" value="home_delivery" class="absolute -z-10 top-1/2 left-1/2 opacity-0" onchange="toggleRequiredOptions()" required />
                </label>
            </div>
            <div class="tabs-contents">
                <div id="pickup-tab" class="tabcontent flex flex-col gap-4 hidden">
                    @forelse($stores as $store)
                    <label class="relative w-full rounded-2xl p-[18px_14px] border border-[#EDEEF0] transition-all duration-300 hover:ring-2 hover:ring-[#FCCF2F] has-[:checked]:ring-2 has-[:checked]:ring-[#FCCF2F]">
                        <div class="flex items-center gap-3">
                            <div class="w-6 h-6 flex shrink-0">
                                <img src="{{asset('assets/images/icons/buildings.svg')}}" alt="icon" />
                            </div>
                        ...
                        <input type="radio" name="store_id" value="{{ $store->id }}" class="absolute -z-10 top-1/2 left-1/2 opacity-0" />
                    </label>
                    @empty
                    <p>Maaf!! tiada data</p>
                    @endforelse
                ...
                <div id="delivery-tab" class="tabcontent flex flex-col hidden">
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="text-xs leading-[22px] text-[#6E6E70]">Sebagai contoh Perumahan Citra Lestari No 12, Blok B 11/7, Jawa Barat, Bogor, 40556</p>
                    </div>
                    <textarea name="address" id="address" class="appearance-none outline-none rounded-2xl border border-[#EDEEF0] p-[14px] bg-white placeholder:text-[#6E6E70] placeholder:font-normal font-semibold text-sm leading-[26px] mt-[10px] resize-none transition-all duration-300 focus:ring-2 focus:ring-[#FCCF2F]" placeholder="Tuliskan alamat rumah anda dengan lengkap agar memudahkan kurir" rows="4"></textarea>
                    <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F6F6F6] mt-5">
                        ...
                        <p class="text-sm leading-[24px] text-[#6E6E70]">Biaya kirim barang gratis untuk seluruh pulau Indonesia, please enjoy!</p>
                    </div>
                </div>
            </div>
        </div>
